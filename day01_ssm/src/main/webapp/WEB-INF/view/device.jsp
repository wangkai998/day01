        ...
        <div class="row">
			  <div class="col-lg-2">
				...
				<div class="input-group">
			      ...
			      <input type="text" name="status" class="form-control" id="txt_search_status" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveDevice.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>设备类型：</td>
								<td colspan="4">
									<select class="form-control" name="devicetype" id = "devicetype" aria-required="true" required>
